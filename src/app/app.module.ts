...
import { CareersForFreshersComponent } from './careers-for-freshers/careers-for-freshers.component';
import { VoiceOfAssociatesComponent } from './voice-of-associates/voice-of-associates.component';
import { FsdJavaDeveloperComponent } from './fsd-java-developer/fsd-java-developer.component';
import { FsdPythonDeveloperComponent } from './fsd-python-developer/fsd-python-developer.component';
import { FsdAndroidDeveloperComponent } from './fsd-android-developer/fsd-android-developer.component';
...
@NgModule({
  declarations: [
    ...
    CareersComponent,
    ContactUsComponent,
    CareersForFreshersComponent,
    VoiceOfAssociatesComponent,
    FsdJavaDeveloperComponent,
    FsdPythonDeveloperComponent,
    FsdAndroidDeveloperComponent,
    GalleryComponent,
    TrainingComponent,
    TalentOutsourcingComponent,
    PlatformForFreshersComponent,
    OurTeamComponent,
    ...
    WeekendTrainingComponent,
    CorporateTrainingComponent,
    CareersatpcsglobalComponent,
    WorkshopComponent,
    BfsComponent,
    LifescienceComponent,
    CeoMessageComponent,
    FoundarMessageComponent,
    OrgThemeVideoComponent,
    ManagementTeamComponent,
    EmployeeSpeakComponent,
